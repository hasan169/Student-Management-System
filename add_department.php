...
?>
 <div class="container-fluid" style="display:inline">
    ...
    <div class="row">
		<div class="col-md-9">
			...
			<div style="margin-top:60px"> </div>
			  <form class="form-horizontal" method="POST" action="add_department.php" role="form">
	...
	<div class="form-group">
      <label class="control-label col-sm-2" >Department Title:</label>
      <div class="col-sm-6">
  ...
  <?php
	...
	if(isset($_POST['reg'])){
		$name = $_POST['name'];
		$title = $_POST['title'];
		$sql = "insert into department values ('$name','$title')";
