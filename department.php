 ...
 <div class="container-fluid" style="display:inline">
    ...
    <div class="row">
		<div class="col-md-9">
			...
			<button class="btn btn-primary" onclick="func()" style="float:right;margin-top:-20px;margin-right:50px"> Add Department </button>
				...
				<table class="table table-bordered" style="color:#a7a7a7;margin-top:5px">
					...
					<tbody>
						...
						while($row = mysql_fetch_array($retval)){
							...
							$title = $row['title'];
						?>		
							<tr><td> <?php echo $name; ?> </td> <td> <?php echo $title; ?> </td></tr>
						<?php } ?>
					</tbody>
				</table>	
			</div>
